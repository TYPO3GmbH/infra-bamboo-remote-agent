...
build_baseimage:
	...
	docker tag ${REGISTRY}$(NAME_BASEIMAGE):$(FULLVERSION_BASEIMAGE) ${REGISTRY}$(NAME_BASEIMAGE):$(SHORTVERSION_BASEIMAGE)
...
release_baseimage:
	...
	docker tag ${REGISTRY}$(NAME_BASEIMAGE):$(FULLVERSION_BASEIMAGE) ${REGISTRY}$(NAME_BASEIMAGE):latest
...
build_php53: build_baseimage
	...
	docker tag ${REGISTRY}$(NAME_PHP53):$(FULLVERSION_PHP53) ${REGISTRY}$(NAME_PHP53):$(SHORTVERSION_PHP53)
...
release_php53:
	...
	docker tag ${REGISTRY}$(NAME_PHP53):$(FULLVERSION_PHP53) ${REGISTRY}$(NAME_PHP53):latest
...
build_php54: build_baseimage
	...
	docker tag ${REGISTRY}$(NAME_PHP54):$(FULLVERSION_PHP54) ${REGISTRY}$(NAME_PHP54):$(SHORTVERSION_PHP54)
...
release_php54:
	...
	docker tag ${REGISTRY}$(NAME_PHP54):$(FULLVERSION_PHP54) ${REGISTRY}$(NAME_PHP54):latest
...
build_php55: build_baseimage
	...
	docker tag ${REGISTRY}$(NAME_PHP55):$(FULLVERSION_PHP55) ${REGISTRY}$(NAME_PHP55):$(SHORTVERSION_PHP55)
...
release_php55:
	...
	docker tag ${REGISTRY}$(NAME_PHP55):$(FULLVERSION_PHP55) ${REGISTRY}$(NAME_PHP55):latest
...
build_php56: build_baseimage
	...
	docker tag ${REGISTRY}$(NAME_PHP56):$(FULLVERSION_PHP56) ${REGISTRY}$(NAME_PHP56):$(SHORTVERSION_PHP56)
...
release_php56:
	...
	docker tag ${REGISTRY}$(NAME_PHP56):$(FULLVERSION_PHP56) ${REGISTRY}$(NAME_PHP56):latest
...
build_php70: build_baseimage
	...
	docker tag ${REGISTRY}$(NAME_PHP70):$(FULLVERSION_PHP70) ${REGISTRY}$(NAME_PHP70):$(SHORTVERSION_PHP70)
...
release_php70:
	...
	docker tag ${REGISTRY}$(NAME_PHP70):$(FULLVERSION_PHP70) ${REGISTRY}$(NAME_PHP70):latest
...
build_php71: build_baseimage
	...
	docker tag ${REGISTRY}$(NAME_PHP71):$(FULLVERSION_PHP71) ${REGISTRY}$(NAME_PHP71):$(SHORTVERSION_PHP71)
...
release_php71:
	...
	docker tag ${REGISTRY}$(NAME_PHP71):$(FULLVERSION_PHP71) ${REGISTRY}$(NAME_PHP71):latest
...
build_php72: build_baseimage
	...
	docker tag ${REGISTRY}$(NAME_PHP72):$(FULLVERSION_PHP72) ${REGISTRY}$(NAME_PHP72):$(SHORTVERSION_PHP72)
...
release_php72:
	...
	docker tag ${REGISTRY}$(NAME_PHP72):$(FULLVERSION_PHP72) ${REGISTRY}$(NAME_PHP72):latest
...
build_php73: build_baseimage
	...
	docker tag ${REGISTRY}$(NAME_PHP73):$(FULLVERSION_PHP73) ${REGISTRY}$(NAME_PHP73):$(SHORTVERSION_PHP73)
...
release_php73:
	...
	docker tag ${REGISTRY}$(NAME_PHP73):$(FULLVERSION_PHP73) ${REGISTRY}$(NAME_PHP73):latest
...
build_php74: build_baseimage
	...
	docker tag ${REGISTRY}$(NAME_PHP74):$(FULLVERSION_PHP74) ${REGISTRY}$(NAME_PHP74):$(SHORTVERSION_PHP74)
...
release_php74:
	...
	docker tag ${REGISTRY}$(NAME_PHP74):$(FULLVERSION_PHP74) ${REGISTRY}$(NAME_PHP74):latest
...
release_bamboo:
	...
	docker tag ${REGISTRY}$(NAME_BAMBOO):$(FULLVERSION_BAMBOO) ${REGISTRY}$(NAME_BAMBOO):$(SHORTVERSION_BAMBOO)
	docker tag ${REGISTRY}$(NAME_BAMBOO):$(FULLVERSION_BAMBOO) ${REGISTRY}$(NAME_BAMBOO):latest
...
release_js:
	...
	docker tag ${REGISTRY}$(NAME_JS):$(FULLVERSION_JS) ${REGISTRY}$(NAME_JS):$(SHORTVERSION_JS)
	docker tag ${REGISTRY}$(NAME_JS):$(FULLVERSION_JS) ${REGISTRY}$(NAME_JS):latest
